import { Component, Output, EventEmitter, ViewChild, AfterViewInit, ContentChildren, QueryList, AfterContentInit, ViewChildren, ChangeDetectorRef, ElementRef, Renderer } from '@angular/core';
